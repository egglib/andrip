package com.egglib.andrip.progressview;
...
public class ProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画圆
        canvas.drawCircle((float) width / 2, (float) height / 2, (width - mStrokeWidth) / 2, mPaint);


        //设置画笔
        mPaint.setAntiAlias(true);
        mPaint.setColor(paintColor == 0 ? Color.WHITE : paintColor);
